...
class DCArticleParser:
    ...
    # 갤러리 타입 가져오기(마이너, 일반)
    def get_gallary_type(self, dc_id: str):
    ...
    def article_parse(self, keyword: str, s_type: str, page=1, search_pos=''):
        try:
    ...
    # 페이지 탐색용 함수
    def page_explorer(self, keyword: str, s_type: str, search_pos=''):
        g_type = self.__g_type
        dc_id = self.__dc_id
        page = {}
